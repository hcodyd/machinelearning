...
from .multi_perceptron import MultiLearner
...
class MLSystemManager:
    ...
    def parser(self):
        ...
        parser.add_argument('-L', required=True, choices=['baseline', 'multilearner', 'perceptron', 'neuralnet', 'decisiontree', 'knn'], help='Learning Algorithm')
